...
public class AstarTreeSearchIT {
    ...
    public void standardGridDeadEndTest(){
        ...
        SearchGraph<DirectedSearchNode> g = new GridGraph(obstacles);

        var testSearch = new AstarTreeSearch<DirectedSearchNode>(new StraightLineDistance(),new GridSnappingSpatialHash(1/75d, new Coordinate()));
    ...
    private class GridGraph implements SearchGraph<DirectedSearchNode>{
